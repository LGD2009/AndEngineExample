...
//		this.mBluetoothServerSocket = BluetoothAdapter.getDefaultAdapter().listenUsingInsecureRfcommWithServiceRecord(this.getClass().getName(), UUID.fromString(this.mUUID)); // TODO Allow insecure!
    ...
    public interface IBluetoothSocketServerListener<CC extends ClientConnector<BluetoothSocketConnection>>
            extends IServerListener<BluetoothSocketServer<CC>> {
        // ===========================================================
        // Final Fields
        // ===========================================================
        ...
        @Override
        void onStarted(final BluetoothSocketServer<CC> pBluetoothSocketServer);

        @Override
        void onTerminated(final BluetoothSocketServer<CC> pBluetoothSocketServer);

        @Override
        void onException(final BluetoothSocketServer<CC> pBluetoothSocketServer, final Throwable pThrowable);

        // ===========================================================
        // Inner and Anonymous Classes
        // ===========================================================

        class DefaultBluetoothSocketServerListener<CC extends ClientConnector<BluetoothSocketConnection>>
				implements IBluetoothSocketServerListener<CC> {
            // ===========================================================
            // Constants
            // ===========================================================
