...
public abstract class SocketServer<CC extends ClientConnector<SocketConnection>> extends Server<SocketConnection, CC> {
	...
	public interface ISocketServerListener<CC extends ClientConnector<SocketConnection>>
			extends IServerListener<SocketServer<CC>> {

		@Override
		void onStarted(final SocketServer<CC> pSocketServer);

		@Override
		void onTerminated(final SocketServer<CC> pSocketServer);

		@Override
		void onException(final SocketServer<CC> pSocketServer, final Throwable pThrowable);

		class DefaultSocketServerListener<CC extends ClientConnector<SocketConnection>> implements ISocketServerListener<CC> {
