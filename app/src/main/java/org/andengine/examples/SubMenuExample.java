...
public class SubMenuExample extends MenuExample {
    ...
    private static final int MENU_QUIT_OK = MenuExample.MENU_BACK + 1;
    ...
    public void onCreateResources() {
        ...
        this.mSubMenuBackTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mSubMenuTexture, this, "menu_back.png", 0, 50);
