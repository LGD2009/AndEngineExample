...
public class TextMenuExample extends SimpleBaseGameActivity implements IOnMenuItemClickListener {
	...
	protected MenuScene createMenuScene() {
		...
		final IMenuItem backMenuItem = new ColorMenuItemDecorator(new TextMenuItem(MENU_BACK, this.mFont, "BACK", this.getVertexBufferObjectManager()), new Color(1,0,0), new Color(0,0,0));
