...
public class XMLLayoutExample extends SimpleLayoutGameActivity {
    ...
    protected Scene onCreateScene() {
        ...
        scene.setOnSceneTouchListener((pScene, pSceneTouchEvent) -> {
        ...
        particleSystem.addParticleModifier(new ScaleParticleModifier<>(0, 5, 1.0f, 2.0f));
        particleSystem.addParticleModifier(new ColorParticleModifier<>(0, 3, 1, 1, 0, 0.5f, 0, 0));
        particleSystem.addParticleModifier(new ColorParticleModifier<>(4, 6, 1, 1, 0.5f, 1, 0, 1));
