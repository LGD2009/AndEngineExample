...
public class PongGameActivity extends SimpleBaseGameActivity implements PongConstants, IOnSceneTouchListener {
        ...
        switch (pID) {
            ...
            case DIALOG_ENTER_SERVER_IP_ID:
                ...
                return new AlertDialog.Builder(this)
                        ...
                        .setCancelable(false)
                        .setView(ipEditText)
                        .setPositiveButton("Connect", (pDialog, pWhich) -> {
							PongGameActivity.this.mServerIP = ipEditText.getText().toString();
							PongGameActivity.this.initClient();
						})
                        .setNegativeButton(android.R.string.cancel, (pDialog, pWhich) -> PongGameActivity.this.finish())
                        .create();
            case DIALOG_CHOOSE_SERVER_OR_CLIENT_ID:
                return new AlertDialog.Builder(this)
                        ...
                        .setNeutralButton("Server", (pDialog, pWhich) -> {
    ...
    private void toast(final String pMessage) {
        this.runOnUiThread(() -> Toast.makeText(PongGameActivity.this, pMessage, Toast.LENGTH_SHORT).show());
    }
